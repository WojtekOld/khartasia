 ...
 *
 */
$drupal_hash_salt = '5sSyyy7q2pN2L3dHcF2sA6wyavJ4XcN7qAP6VPS5CDo';
...
/**
If Allowed memory size of 134217728 bytes exhausted .... (AK)
**/
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_dl2_dd.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/loc_dl2_dd.inc';
}
// </DDSETTINGS>
