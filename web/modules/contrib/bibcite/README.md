 ...
 **Bibliography & Citation module is under active development. It is not ready for use on production sites and breaking changes are possible until Beta**
 ...
 * In case you manage your site dependencies manually or via Drush, install
   ...
   `composer require seboettg/citeproc-php:^2.6 adci/full-name-parser:^0.2.4 researchgate/libris:~2.0 renanbr/bibtex-parser:^2.2.0 caseyamcl/php-marc21:~1.0`
