...
class ReferenceSettingsLinksForm extends ConfigFormBase {
   ...
   *   Link plugin manager.
   */
  public function __construct(ConfigFactoryInterface $config_factory, TypedConfigManagerInterface $typedConfigManager, PluginManagerInterface $bibcite_link_manager) {
