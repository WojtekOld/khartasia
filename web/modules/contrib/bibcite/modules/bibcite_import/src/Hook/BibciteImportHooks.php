...
namespace Drupal\bibcite_import\Hook;
...
/**
 * Hook implementations for bibcite_import.
 */
class BibciteImportHooks {
   ...
   */
  #[Hook('bibcite_reference_prepare_form')]
  public static function bibciteReferencePrepareForm(ReferenceInterface $entity, $operation, FormStateInterface $form_state) {
