...
namespace Drupal\color_field_widget_grid\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the 'color_field_widget_grid' widget.
 *
 * @FieldWidget(
 *   id = "color_field_widget_grid",
 *   module = "color_field_widget_grid",
...
class ColorFieldWidgetGrid extends ColorFieldWidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state): array {
    ...
    $element['#attached']['library'][] = 'color_field_widget_grid/color-field-widget-grid';
