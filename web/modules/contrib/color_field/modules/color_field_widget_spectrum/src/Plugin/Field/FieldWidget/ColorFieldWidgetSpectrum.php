...
namespace Drupal\color_field_widget_spectrum\Plugin\Field\FieldWidget;
...
/**
 * Plugin implementation of the color_field_widget_spectrum widget.
 *
 * @FieldWidget(
 *   id = "color_field_widget_spectrum",
 *   module = "color_field_widget_spectrum",
...
class ColorFieldWidgetSpectrum extends ColorFieldWidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state): array {
    ...
    $element['#attached']['library'][] = 'color_field_widget_spectrum/color-field-widget-spectrum';
