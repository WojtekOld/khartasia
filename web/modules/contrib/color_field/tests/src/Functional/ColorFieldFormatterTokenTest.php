...
class ColorFieldFormatterTokenTest extends ColorFieldFunctionalTestBase {
  ...
  public function testTokens(): void {
    ...
    $this->assertSession()->responseContains('.node-article { background-color: rgb(156 89 209 / 0.95); }');
    ...
    $this->drupalGet('node/add/article');
    $this->submitForm($edit, 'Save');
    $this->assertSession()->responseContains('.node-article { background-color: rgb(0 0 0 / 0.1); }');
    $this->assertSession()->responseContains('.node-article { color: rgb(0 0 0); }');
  }
